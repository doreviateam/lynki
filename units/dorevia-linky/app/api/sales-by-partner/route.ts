...
/**
 * GET /api/sales-by-partner — proxy vers Vault GET /ui/aggregations/sales-by-partner (Pareto 80/20)
 */
export async function GET(request: NextRequest) {
  ...
  const url = `${VAULT_URL.replace(/\/$/, "")}/ui/aggregations/sales-by-partner?${params.toString()}`;
