...
/**
 * GET /api/payroll — proxy vers Vault GET /ui/aggregations/payroll
 * Charges de personnel (odoo_model = 'hr.payslip', événement payroll.charge.posted).
 * Paramètres : tenant, date_debut, date_fin, granularity, company_id
 */
export async function GET(request: NextRequest) {
  ...
  const url = `${VAULT_URL.replace(/\/$/, "")}/ui/aggregations/payroll?${params.toString()}`;
