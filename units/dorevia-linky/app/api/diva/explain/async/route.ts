/**
 * POST /api/diva/explain/async — Proxy vers DIVA async
 * Retourne 202 { context_hash } ou 200 { flash } (cache hit)
 * SPEC : ZeDocs/web22/SPEC_DIVA_Async_v1.0.md
 */
...
// Réponse rapide (cache hit ou 202) ; pas de timeout long
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Détails enrichis pour la carte ciblée (envoi à Mistral)
    ...
    const res = await fetch(`${base}/ui/diva/explain/async`, {
      method: "POST",
