...
/**
 * GET /api/ar-by-partner — proxy vers Vault GET /ui/aggregations/ar-by-partner (SPEC AR by Partner)
 * Encours & Clients à risque (retard).
...
export async function GET(request: NextRequest) {
  ...
  const url = `${VAULT_URL.replace(/\/$/, "")}/ui/aggregations/ar-by-partner?${params.toString()}`;
