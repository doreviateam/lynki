...
**Version :** 1.1.15 — mars 2026  
**Lot :** Web60  
**Statut :** protocole de validation publié  
**Plan :** [`PLAN_WEB60_LINKY_UI.md`](./PLAN_WEB60_LINKY_UI.md) **v1.1.19** · **Doctrine :** [`DOCTRINE_ETATS_UI_LINKY.md`](./DOCTRINE_ETATS_UI_LINKY.md) **v1.1.2** · **Spec maîtresses :** [`SPEC_CARTES_MAITRESSES_LINKY.md`](./SPEC_CARTES_MAITRESSES_LINKY.md) **v1.1.16** · **Backlog :** [`BACKLOG_WEB60_LINKY.md`](./BACKLOG_WEB60_LINKY.md) **v1.1.8** · **Exécution :** [`EXECUTION_TICKETS_WEB60_LINKY.md`](./EXECUTION_TICKETS_WEB60_LINKY.md) **v1.1.17**  
...
|----------|---------|--------|
| [`PLAN_WEB60_LINKY_UI.md`](./PLAN_WEB60_LINKY_UI.md) | **v1.1.19** | Cadrage publié |
...
| [`BACKLOG_WEB60_LINKY.md`](./BACKLOG_WEB60_LINKY.md) | **v1.1.8** | Backlog ouvert (**W60-101** / **W60-102** Fait ; **W60-103** En cours) |
| [`EXECUTION_TICKETS_WEB60_LINKY.md`](./EXECUTION_TICKETS_WEB60_LINKY.md) | **v1.1.17** | Guide d’exécution publié (**§5.3** / **§5.3.1** **W60-103** ; **Passe 2** ; **lab public** / **UI hash** ; **§4.2** **W60-005** ; **§14** trame **T-W60-002**) |
...
* **Exécution** : [`EXECUTION_TICKETS_WEB60_LINKY.md`](./EXECUTION_TICKETS_WEB60_LINKY.md) **v1.1.17** — **§13** journal ; **lab public** = vérité recette + **UI hash** ; **§4.2** **W60-005** ; **§5.3.1** contour cockpit ; **§14** trio + trame **T-W60-002** ; **R60** §10 ; **lab** + **`laplatine2026`**.
...
* [ ] **Dominance** : première lecture incontestable du cockpit (W60-101).  
* [ ] **État principal** : qualité de lecture (**Fiable**, **Partiel**, **En attente**, **Indisponible** selon cas) — pas « Synchro OK » seul comme badge unique structurant (W60-102, W60-103).  
...
* [ ] **W60-101** — dominance Trésorerie  
* [ ] **W60-102** — pas de « Synchro OK » seul comme lecture principale  
* [ ] **W60-103** — état principal de qualité cohérent (Trésorerie)  
